...
function FormTipoReportes() {
  ...
  return (
    <>
      <header><Navbar active='tipo_reportes' /></header>
      <main className='d-flex flex-column justify-content-center align-items-center bg-main flex-grow-1 px-3 px-md-0'>
        ...
        <form onSubmit={onSubmit} className='w-100 w-md-80 bg-white rounded py-5 px-2 px-md-5 text-center'>
          <h1 className='fw-bold text-center'>Registro de Tipo de Reporte</h1>
          ...
          <TexTarea
            ...
            placeholder={"Describa el tipo de reporte"}
            rows={3}
            params={{
              required: {
                value: true,
...
export default FormTipoReportes